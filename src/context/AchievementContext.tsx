...
export const ACHIEVEMENT_DEFS: Achievement[] = [
  ...
  { id: 'calendar-tetris',      name: 'Calendar Tetris',         icon: '📅', description: 'Clear 4 rows at once — TETRIS!' },
  { id: 'efficiency-expert',    name: 'Efficiency Expert',       icon: '⚡', description: 'Clear 20 rows in one game.' },
  { id: 'combo-master',         name: 'Combo Master',            icon: '🔥', description: 'Get a 5x combo.' },
  { id: 'calendar-survivor',    name: 'Calendar Survivor',       icon: '🗓️', description: 'Reach level 10.' },
  { id: 'calendar-zen',         name: 'Calendar Zen',            icon: '🧘', description: 'Play for 5 minutes without game over.' },
  { id: 'meeting-minimalist',   name: 'Meeting Minimalist',      icon: '📧', description: 'Use "Make it an Email" 10 times total.' },
  { id: 'inbox-zero',           name: 'Inbox Zero',              icon: '✨', description: 'Clear the entire board — no blocks remaining.' },
  { id: 'overbooked',           name: 'Overbooked',              icon: '💀', description: 'Lose with every column having at least one block.' },
