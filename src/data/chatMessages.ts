...
export function getInitialMessages(): ChatMessage[] {
  ...
  return [
    ...
    // #memes
    {
      ...
      isRead: true,
      memeData: { template: 'drake', items: ['Reading the brief', 'Vibing the brief'] },
    },
    {
      id: 'seed-15',
      channel: 'memes',
      ...
      reactions: [],
      isRead: true,
      memeData: { template: 'quote', items: ['Morgan: "this blue is NOT that blue"', 'Client: "they look the same to me"'] },
    },
    {
      id: 'seed-16',
      channel: 'memes',
